...
public class Presidente implements Serializable {
    ...
    public Presidente(Integer cpf) {
        this.cpf = cpf;
    }

    public Presidente(Integer cpf, String nome) {
        this.cpf = cpf;
        this.nome = nome;
    }
    ...
    public String toString() {
        return "Presidente{" + "nome=" + nome + ", cpf=" + cpf + ", votos=" + votos + '}';
    }
    ...
    public boolean equals(Object obj) {
        ...
        final Presidente other = (Presidente) obj;
