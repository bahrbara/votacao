...
@NamedQueries({
    @NamedQuery(name = "Governador.findAll", query = "SELECT p FROM Governador p")})
public class Governador implements Serializable {
    ...
    public Governador(Integer cpf) {
        this.cpf = cpf;
    }

    public Governador(Integer cpf, String nome) {
        this.cpf = cpf;
        this.nome = nome;
    }
    ...
    public String toString() {
        return "Governador{" + "nome=" + nome + ", cpf=" + cpf + ", votos=" + votos + '}';
    }
    ...
    public boolean equals(Object obj) {
        ...
        final Governador other = (Governador) obj;
